 ...
 */
(function () {
    var e = $('<div id="galleryOverlay">'), t = $('<div id="gallerySlider">'), n = $('<a id="prevArrow"><i class="icon-angle-left icon-4x"></i></a>'), r = $('<a id="nextArrow"><i class="icon-angle-right icon-4x"></i></a>'), i = !1;
    $.fn.touchTouch = function () {
        ...
        e.hide().appendTo("body"), t.appendTo(e), u.each(function () {
            ...
            var n = e.originalEvent, r = n.changedTouches[0].pageX;
